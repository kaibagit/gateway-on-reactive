...
public class GatewayInboundHandler extends SimpleChannelInboundHandler<FullHttpRequest>{
    ...
    public GatewayInboundHandler(Scheduler blockScheduler){
...
//                            applicationQa.setUpdTm(new Date(record.getLong("upd_tm")));
                    ...
                    sink.error(new OpenGatewayException(CodeEnum.SYS_INVALID_PARAMETER,"无效的appkey"));
                }
            }catch (Exception e){
                sink.error(e);
            }finally {
